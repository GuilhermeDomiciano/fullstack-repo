...
- Read: `tasks/<ISSUE_ID>/US-<ISSUE_ID>-api-contract.md` — endpoints + "Agentes necessários"
- Read: `tasks/<ISSUE_ID>/US-<ISSUE_ID>-<nome>.txt` — critérios de aceitação
...
### 4. Registro
Write: `tasks/<ISSUE_ID>/US-<ISSUE_ID>-qa-report.md` com:
```markdown
# QA Report — US-<ISSUE_ID>
